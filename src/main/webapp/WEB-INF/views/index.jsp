...
<body>
				...
				<div class="carousel-inner">
					<div class="item active">
						<img class="slide-image"
							src="<c:url value="resources/IMAGES/Images/nc.jpg"/>" alt="">
					</div>
					<div class="item">
						<img class="slide-image"
							src="<c:url value="resources/IMAGES/Images/nc1.jpg"/>" alt="">
					</div>
					<div class="item">
						<img class="slide-image"
							src="<c:url value="resources/IMAGES/Images/nc3.jpg"/>" alt="">
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-sm-3 col-lg-3 col-md-3">
			<div class="thumbnail">
				<img src="<c:url value="resources/IMAGES/Images/img44.jpg"/>" alt="">
